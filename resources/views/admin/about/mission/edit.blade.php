...
@section('content')
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <form class="form" action="{{ url('admin/about/mission/edit/'.$mission->id) }}" method="post">
          @csrf
          <label for="ruangan">Mission <small class=""></small> </label>
          <div class="form-group">
              <div class="col-xs-4">
                  <input type="text" name="mission" class="form-control" placeholder="Mission" required value="{{ $mission->mission }}">
              </div>
          </div>
          <div class="form-group">
              <div class="col-xs-6">
