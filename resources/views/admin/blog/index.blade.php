  ...
  <div class="container">
    <div class="row page-titles">
      ...
      <div class="col-md-7 align-self-center text-right d-none d-md-block">
        <a href="{{ url('admin/blog/formadd') }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Create New</a>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
                ...
                <tbody>
                  @foreach ($blog as $key => $data)
                    <tr>
                      ...
                      <td style="vertical-align: middle">{{ strip_tags($data->content) }}</td>
                      <td style="vertical-align: middle">
                        <a href="{{ url('admin/blog/edit/'.$data->id) }}" class="btn btn-info"><i class="fa fa-edit"></i> Edit</a>
