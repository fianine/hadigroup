  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        @endif
        <form class="form" action="{{ url('admin/blog/update/'.$blog->id) }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-group">
                <label>Content</label>
                <textarea required name="content" class="summernote">{{ $blog->content }}</textarea>
              </div>
              <div class="form-group">
